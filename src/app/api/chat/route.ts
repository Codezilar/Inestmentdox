...
const SYSTEM_PROMPT = `You are Goldman Bank AI - the intelligent banking assistant. Respond directly and naturally as if you're a knowledgeable human agent.
...
const DIRECT_RESPONSES = [
  ...
  },
  {
    ...
    response: "You can deposit funds via bank transfer, mobile check deposit, or at any Goldman Bank ATM."
  },
  {
  ...
  },
  {
    ...
    response: "To send money, go to 'Transfers' in your dashboard. You can transfer to other Goldman Bank accounts or external banks."
  },
  ...
  },
  {
    ...
    response: "Yes, property investors earn monthly rental income which is automatically credited to your Goldman Bank account."
  },
  {
  ...
  },
  {
    ...
    response: "We're sorry to hear that! Please send your complaint or feedback to Goldman Bank@gmail.com."
  },

  // === GREETINGS & SMALL TALK ===
  {
    patterns: [/hello|hi|hey/i],
    response: "Hi! I'm Goldman Bank AI. How can I assist with your banking today?"
  },
  {
  ...
  },
  {
    ...
    response: "Goodbye! Thanks for banking with Goldman Bank."
  },
  ...
  { 
    ...
    response: "You can withdraw cash at any Goldman Bank ATM or partner ATM globally." 
  },
  { 
  ...
  { 
    ...
    response: "Earn cashback and points when you use your Goldman Bank card for purchases!" 
  },
  { 
  ...
  { patterns: [/instant transfer/i], response: "Yes! Instant transfers between Goldman Bank users are available 24/7." },
  ...
  { patterns: [/direct deposit/i], response: "Yes, you can set up direct deposits from your employer. Use your Goldman Bank account and routing number." },
  { patterns: [/cash deposit/i], response: "Cash deposits can be made at any Goldman Bank partner ATM or local branch." },
  ...
  { patterns: [/close business account/i], response: "To close your business account, please contact business support at business@Goldman Bank.com." },
  ...
  { patterns: [/atm nearby/i], response: "Find the nearest Goldman Bank ATM in your app under 'ATM Locator'." },
  ...
  { patterns: [/contact ceo|manager/i], response: "For executive inquiries, please email corporate@Goldman Bank.com." },
  { patterns: [/bank license|regulated/i], response: "Yes, Goldman Bank is a fully licensed and regulated financial institution." },
  { patterns: [/terms|privacy policy/i], response: "You can view our terms and privacy policy at Goldman Bank.com/legal." },
  ...
  { patterns: [/newsletter/i], response: "Subscribe to our newsletter for financial tips and updates from Goldman Bank." },
];
...
export async function POST(req: Request) {
  ...
  try {
    ...
    if (!lastMessage.trim()) {
      return NextResponse.json({
        reply: "Hi! I'm Goldman Bank AI. How can I help you today?"
      });
    }
